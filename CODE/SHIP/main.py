...
def make_params(X, y, meta_info, ds_name):
    ...
    print("Running for:" + str(params['anchor_points']['K']) + " and Learning Rate=" + str(
        params['learning']['learning_rate']))
    return params
...
def run(ds_name):
    ...
    for i in range(10):  # Number of different trees
        ...
        out_file_pkl = os.path.join(ds_dir, make_filename(params) + "_PosNeg" + str(K) + "_" + str(
            learning_rate) + "_Sample_" + str(i) + ".pkl")
